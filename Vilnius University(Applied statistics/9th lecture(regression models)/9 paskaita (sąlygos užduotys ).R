...
lm6 <- lm(Species~Elevation+I(Elevation^2)+I(Elevation^3)+I(Elevation^4)+I(Elevation^5)+I(Elevation^6))
lm7 <- lm(Species~Elevation+I(Elevation^2)+I(Elevation^3)+I(Elevation^4)+I(Elevation^5)+I(Elevation^6)+I(Elevation^7))
...
#Nors lm5 regresoriai stat. nereiksmingi, bet lm7 p reikmes sumazejo, tai gali buti, kad jos vel sumazes maziau nei 0.05?
